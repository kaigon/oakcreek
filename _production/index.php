<!DOCTYPE html>
<!--[if lte IE 9]>         <html class="no-js ie9" lang=""> <![endif]-->
<!--[if gt IE 9]><!-->
...
<?php
    ...
    <body <?php if($mobile===true || $phone===true || $tablet===true){echo $class;} ?>>
        <!--[if lte IE 8]>
            <div class="browsehappy">
                <div>
                    ...
                    <p class="browserupgrade">We are sorry, your browser is incompatible with our site's layout / functionality.</p>
                    <p>Please <a href="http://browsehappy.com/">upgrade your browser</a>.</p>   
                    <img src="img/logo_color.png" alt="Oakcreek Printing and Mailing">                    
                </div>
            </div>
        <![endif]-->
        <header class="header">
        ...
        <section class="about">
            <main class="container-fluid">
                <div class="about__row">
                    <div class="about__col about__col---has-bio about__col--10">
                        <figure class="about__figure">
                            <img src="img/about/1.jpg" alt="" class="about__img" />
                        </figure>
                        <div class="about__bio">
                            <h3 class="about__bio--name">Matt Kasik</h3>
                            <p class="about__bio--title">
                    ...
                    <div class="about__col hidden-xs about__col--14">
                        <figure class="about__figure">
                            <img src="img/about/2.jpg" alt="" class="about__img" />
                        </figure>
                    </div>
                </div>
                <div class="about__row">
                    <div class="about__col about__col--16">
                        <div class="about__row">
                            <div class="about__col about__col--14">
                                <figure class="about__figure">
                                    <img src="img/about/3.jpg" alt="" class="about__img" />
                                </figure>
                            </div>
                            <div class="about__col about__col--10">
                                <figure class="about__figure">
                                    <img src="img/about/4.jpg" alt="" class="about__img" />
                                </figure>
                            </div>
                        </div>
                        <div class="about__row">
                            <div class="about__col about__col--10">
                                <figure class="about__figure">
                                    <img src="img/about/6.jpg" alt="" class="about__img" />
                                </figure>
                            </div>
                            <div class="about__col about__col--14">
                                <div class="about__row">
                                    <div class="about__col">
                                        <figure class="about__figure">
                                            <img src="img/about/7.jpg" alt="" class="about__img" />
                                        </figure>
                                    </div>
                                </div>
                                <div class="about__row">
                                    <div class="about__col">
                                        <figure class="about__figure">
                                            <img src="img/about/8.jpg" alt="" class="about__img" />
                                        </figure>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="about__col hidden-xs about__col--8">
                        <figure class="about__figure">
                            <img src="img/about/5.jpg" alt="" class="about__img" />
                        </figure>
                    </div>
                </div>
            </main>
                        ...
                        <form id="ajax-contact" method="POST" action="mailer.php" accept-charset="utf-8" class="end-md">
                            <div class="content row">
                                ...
                                <fieldset class="col-xs-12">
                                    <legend class="required">Your Message</legend>
            ...
            <footer>
                <div class="container-fluid">
                    <div style="padding-bottom:4rem;">
                        <p>926 P Street
                            <br>Lincoln, NE 68508</p>
                        <p><i class="icon-map"></i> <a href="https://www.google.com/maps/place/Oakcreek+Printing+Mailing/@40.816428,-96.707726,16z/data=!4m5!3m4!1s0x0:0x7c6b415f2fc603f0!8m2!3d40.816428!4d-96.7077259?hl=en-US">Find us!</a></p>
                    </div>
                </div>
            </footer>
            <?php endif; ?>
        ...
        <?php 
            ...
            ?>
        <!-- load jquery -->
        <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.0/jquery.min.js" async defer></script>
        <script>
        window.jQuery || document.write('<script src="js/vendor/jquery-1.12.0.min.js" async defer><\/script>')
        </script>
        <script src="https://www.google.com/recaptcha/api.js" async defer></script>
        <script src="js/vendor/custom-modernizr.js" async defer></script>
        <script src="js/production.min.js" async defer></script>
        <!-- Google Analytics -->
        <script>
